    ...
    <div style={{ minHeight: "100dvh", backgroundColor: "#f3f4f6", fontFamily: "Roboto, sans-serif" }}>
      ...
      <div className="bar-content">
        ...
        <div className="bar-count-chip">
          ...
          <span className="bar-count-value bar-count-value--hot">{items.length}</span>
        </div>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: "center", padding: "40px" }}>
            ...
            <div style={{ color: "#80868b", fontWeight: 500, fontSize: "1rem" }}>Sin bebidas calientes pendientes</div>
          </div>
        ) : (
              ...
              return (
                <div key={item.id} className="bar-table-row" style={{
                  ...
                  <button
                    ...
                    className="bar-check-btn"
                    style={{
                      borderColor: isUrgent ? "#d93025" : "#e65100",
                    }}
                  >
                    {marking === item.id ? (
                  ...
                  <span className="bar-cant bar-cant--hot">{item.cantidad}×</span>
                  <div>
...
const BAR_STYLES = `
  ...
  .bar-count-value--hot { color: #e65100; }
  ...
  .bar-table-row:active { background: #fff3e0 !important; }
