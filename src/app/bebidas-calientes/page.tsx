  ...
  return (
    <div style={{ minHeight: "100dvh", backgroundColor: "#f3f4f6", fontFamily: "Roboto, sans-serif" }}>
      ...
      <header style={{
        ...
        boxShadow: "0 2px 8px rgba(230,81,0,0.4)", zIndex: 1000
      }}>
        ...
        <div style={{ fontSize: "1.1rem", fontWeight: 700 }}>☕ Beb. Calientes</div>
      ...
      <div style={{ paddingTop: "68px", paddingBottom: "68px", maxWidth: "900px", margin: "0 auto", padding: "68px 8px" }}>
        ...
        <div style={{ backgroundColor: "white", borderRadius: "8px", padding: "10px 16px", marginBottom: "12px", boxShadow: "0 1px 2px rgba(0,0,0,0.08)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <span style={{ fontSize: "1.5rem", fontWeight: 700, color: "#e65100" }}>{items.length}</span>
        </div>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: "center", padding: "48px" }}>
            ...
            <div style={{ color: "#80868b", fontWeight: 500 }}>Sin bebidas calientes pendientes</div>
          </div>
        ) : (
            ...
            {items.map(item => {
              ...
              return (
                <div key={item.id} className="kds-sub-row" style={{
                  ...
                  <span style={{ fontSize: "1rem", fontWeight: 800, color: "#e65100" }}>{item.cantidad}×</span>
                  <div>
      ...
      <nav className="kds-bottom-nav">
        ...
        <div className="kds-nav-item kds-nav-active" style={{ color: "#e65100", background: "#fff3e0" }}>
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
